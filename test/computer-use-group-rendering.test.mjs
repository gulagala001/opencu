...
test('generic tool followed by file writes retains a live disclosure and survives reload and completion', { timeout: 90000 }, async t => {
  ...
  assert.ok(await page.locator('[data-chat-call-id="generic"] :is(button,[role="button"]):visible').count());
  await group.click();

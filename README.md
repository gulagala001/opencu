...
当前正式版本：[1.1.0](https://github.com/gulagala001/opencu/releases/tag/v1.1.0)。源码、发行包与 SHA-256 校验文件见版本页面。

## 本版更新

适配 DSH 0.1.7-alpha.1 的原生消息分组、设置和会话接口；合并重复的分组实现，修复独立版与 Oh My DSH 的挂载顺序及配置归属。浏览器、桌面操作、实时预览和接管能力完整保留。

[版本说明与验证范围](docs/release-1.1.0.md)。

## 安装

当前正式版 **1.1.0** 适配 **DSH 0.1.7-alpha.1 Web、Node.js ≥22.19、pnpm 11.23.0 和 Git**。先停止 DSH 服务，再运行：

...
// ../opencu/src/client/state-pool.mjs
...
// ../opencu/src/client/host-browser.mjs
...
// ../opencu/src/client/computer-icons.jsx
...
// ../opencu/src/client/device-frame.jsx
...
// ../opencu/src/client/native-preview.jsx
...
// ../opencu/src/client/browser-controls.jsx
var import_react10 = __toESM(require("react"), 1);

// ../opencu/src/client/browser-tools.jsx
var import_react7 = __toESM(require("react"), 1);

// ../opencu/src/client/tool-image.jsx
...
// ../opencu/src/client/browser-downloads.jsx
...
// ../opencu/src/client/browser-history.jsx
...
// ../opencu/src/client/slot-decoration.mjs
...
// ../opencu/src/client/computer-reference.jsx
...
// ../opencu/src/client/computer-groups.jsx
var import_react12 = __toESM(require("react"), 1);
var import_react_dom2 = require("react-dom");

// ../opencu/src/client/computer-groups.mjs
...
function latestOperation(block) {
  ...
  const target = kind === "read" || kind === "edit" || kind === "image" ? path : kind === "command" ? first(args.command, args.cmd) : kind === "search" ? first(args.pattern, args.query, args.q) : kind === "web" ? first(args.url) : "";
...
var processContextKinds = /* @__PURE__ */ new Set(["context", "system-prompt", "omd-task-injection"]);
function computerGroups(nodes, toolviewNames) {
  ...
  for (const node of nodes) {
    ...
    const turn = node.location?.turn?.turn ?? node.data.turn ?? (context ? group?.turn ?? "context:" + node.key : void 0);
    ...
    if (!group || group.turn !== turn) group = { id: node.key, turn, keys: [], callKeys: /* @__PURE__ */ new Map(), calls: [], names: [], contexts: 0, running: false, turnActive: false, failures: 0, stopped: 0, title: "" };
    ...
    if (tool) {
      ...
      group.callKeys.set(root.callId, node.key);
...
function LatestAction({ action }) {
  return /* @__PURE__ */ import_react12.default.createElement(import_react12.default.Fragment, null, /* @__PURE__ */ import_react12.default.createElement("strong", { "data-cu-latest-action": true, title: action.label }, action.label), /* @__PURE__ */ import_react12.default.createElement("span", { "data-cu-action-state": action.state, className: action.state === "error" ? "tx-cu-error" : void 0 }, { running: "\u8FDB\u884C\u4E2D", done: "\u5DF2\u5B8C\u6210", error: "\u5931\u8D25", stopped: "\u5DF2\u505C\u6B62" }[action.state]));
}
function computerGroupPresentation(ctx) {
  const genericViews = /* @__PURE__ */ new Map(), fallbackScans = /* @__PURE__ */ new WeakMap();
  const cache = /* @__PURE__ */ new WeakMap(), processCache = /* @__PURE__ */ new WeakMap(), open = /* @__PURE__ */ new Set(), lists = /* @__PURE__ */ new Map(), listeners = /* @__PURE__ */ new Set();
  const notify = () => {
  ...
  function GenericTool({ block, toolName, inspect, loadImage }) {
    const action = latestOperation(block), [expanded, setExpanded] = (0, import_react12.useState)(false);
    return /* @__PURE__ */ import_react12.default.createElement("div", { className: "tx-cu-card", "data-cu-generic-tool": toolName }, /* @__PURE__ */ import_react12.default.createElement("button", { type: "button", className: "tx-cu-card-heading", "aria-expanded": expanded, onClick: () => setExpanded((value) => !value) }, /* @__PURE__ */ import_react12.default.createElement(ComputerIcon, { name: action.icon, size: 16 }), /* @__PURE__ */ import_react12.default.createElement(LatestAction, { action })), expanded && /* @__PURE__ */ import_react12.default.createElement("div", { className: "tx-cu-card-body" }, /* @__PURE__ */ import_react12.default.createElement("pre", null, block.call?.argsRaw ?? block.argsRaw), (block.content ?? []).map((item, index) => item.type === "image" && item.attachment ? /* @__PURE__ */ import_react12.default.createElement(SavedImage, { key: index, attachment: item.attachment, loadImage }) : /* @__PURE__ */ import_react12.default.createElement("pre", { key: index }, item.type === "text" ? item.text : JSON.stringify(item, null, 2))), block.error && /* @__PURE__ */ import_react12.default.createElement("pre", { className: "tx-cu-error" }, block.error.reason || block.error.message || block.error.code), /* @__PURE__ */ import_react12.default.createElement("button", { type: "button", onClick: inspect }, "\u67E5\u770B\u5B8C\u6574\u8C03\u7528")));
  }
  function Group({ sessionId, useChat, nodeKey, callId, turnProcess, completedContext = false, children }) {
    const toolviews = (0, import_react12.useSyncExternalStore)(subscribeToolviews, readToolviews);
    ...
    (0, import_react12.useLayoutEffect)(() => {
      ...
      for (const node of snapshot.nodes.values()) if (node.kind === "tool-call") {
        ...
        if (name && !genericViews.has(name) && !toolviews.some((entry) => entry.options.key === name)) {
          genericViews.set(name, ctx.slots.register({ name: "tool.call.toolview", key: name, priority: 1e6 }, GenericTool));
        }
      }
    }, [snapshot, toolviews]);
    const identity = `${sessionId}:${group?.id}`;
    const expanded = (0, import_react12.useSyncExternalStore)(subscribe, () => open.has(identity));
    const wasFoldable = (0, import_react12.useRef)(false), [visited, setVisited] = (0, import_react12.useState)(false), listId = (0, import_react12.useId)();
    const first = !!group && (nodeKey ? nodeKey === group.id : group.headerCallId === callId), foldable = !!turnProcess?.foldable || completedContext;
    const target = (0, import_react12.useSyncExternalStore)(subscribe, () => lists.get(identity));
    const listRef = (0, import_react12.useCallback)((element) => {
      if (element) lists.set(identity, element);
      else lists.delete(identity);
      notify();
    }, [identity]);
    (0, import_react12.useLayoutEffect)(() => {
    ...
    if (!group) return /* @__PURE__ */ import_react12.default.createElement("div", { style: { display: "contents" }, "data-cu-group-hidden": completedContext && !turnProcess.open || void 0, "data-cu-process-context": completedContext || void 0 }, children);
    ...
    return /* @__PURE__ */ import_react12.default.createElement("div", { className: "tx-cu-group", "data-cu-group": first ? group.id : void 0, "data-cu-group-hidden": !first || completedContext && !turnProcess.open || void 0 }, first && /* @__PURE__ */ import_react12.default.createElement(import_react12.default.Fragment, null, /* @__PURE__ */ import_react12.default.createElement("button", { type: "button", className: "tx-cu-group-toggle", "aria-expanded": expanded, "aria-controls": listId, title: group.title || void 0, onClick: toggle }, /* @__PURE__ */ import_react12.default.createElement(ComputerIcon, { name: latest?.icon || (group.calls.length ? operationIcon(group.names) : "book"), size: 16 }), latest ? /* @__PURE__ */ import_react12.default.createElement(LatestAction, { action: latest }) : /* @__PURE__ */ import_react12.default.createElement("strong", null, label), group.calls.length > 0 && /* @__PURE__ */ import_react12.default.createElement("span", null, group.calls.length, " \u6B21\u64CD\u4F5C"), group.failures > 0 && /* @__PURE__ */ import_react12.default.createElement("span", { className: "tx-cu-error" }, group.failures, " \u6B21\u5931\u8D25"), group.stopped > 0 && /* @__PURE__ */ import_react12.default.createElement("span", null, group.stopped, " \u9879\u5DF2\u505C\u6B62"), /* @__PURE__ */ import_react12.default.createElement(ComputerIcon, { className: "tx-cu-disclosure", name: "chevron", size: 12 })), /* @__PURE__ */ import_react12.default.createElement("div", { ref: listRef, id: listId, className: "tx-cu-group-list", role: "region", "aria-label": label + "\u8BE6\u60C5", tabIndex: 0, hidden: !expanded })), target && (expanded || visited) && (0, import_react_dom2.createPortal)(/* @__PURE__ */ import_react12.default.createElement("div", { className: "tx-cu-group-item", "data-cu-operation": callId || void 0, "data-chat-call-id": callId || void 0, "data-cu-process-node": nodeKey || void 0, style: { order } }, children), target));
  }
  ctx.slots.inject("conversation.chat.node", () => {
    const dispose = decorateSlot(ctx.slots, "conversation.chat.node", (key) => ["assistant-step", "turn-process", ...processContextKinds].includes(key), (original) => {
      ...
      function GroupedProcess(props) {
        ...
        const seconds = turn?.start && turn?.end ? Math.max(0, Math.round((turn.end.time - turn.start.time) / 1e3)) : null;
        ...
        return /* @__PURE__ */ import_react12.default.createElement("button", { type: "button", className: "tx-cu-group-toggle tx-cu-turn-toggle", "data-turn-process": props.node.data.turn, "data-turn-process-tool-calls": props.node.data.toolCallCount, "aria-expanded": props.turnProcess.open, title: props.node.data.toolCallCount + " \u6B21\u5DE5\u5177\u8C03\u7528", onClick: () => props.turnProcess.setOpen(!props.turnProcess.open) }, /* @__PURE__ */ import_react12.default.createElement("strong", null, duration), failures > 0 && /* @__PURE__ */ import_react12.default.createElement("span", { className: "tx-cu-error" }, failures, " \u9879\u5931\u8D25"), stopped > 0 && /* @__PURE__ */ import_react12.default.createElement("span", null, stopped, " \u9879\u5DF2\u505C\u6B62"), /* @__PURE__ */ import_react12.default.createElement(ComputerIcon, { className: "tx-cu-disclosure", name: "chevron", size: 12 }));
      }
    ...
    return () => {
      dispose();
      for (const disposeView of genericViews.values()) disposeView();
      genericViews.clear();
      open.clear();
      lists.clear();
      listeners.clear();
  ...
  ctx.slots.inject("tool.call.toolview", () => decorateSlot(ctx.slots, "tool.call.toolview", () => true, (original) => {
    ...
    return { options: { ...options, name: "tool.call.toolview", locale: original.locale, inject: original.inject, children: void 0, priority: (options.priority ?? 0) - 1 }, component: GroupedTool };
  }));
  return Group;
}

// ../opencu/src/client/computer-setup.jsx
...
// ../opencu/src/client/window-share.jsx
...
// ../opencu/src/client/floating-preview.jsx
...
// ../opencu/src/client/page-annotation.jsx
var import_react16 = __toESM(require("react"), 1);

// ../opencu/src/computer-use/annotation-geometry.mjs

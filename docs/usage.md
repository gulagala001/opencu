...
当前 1.0.4适配 DSH 0.1.6-alpha.2。固定版本安装命令及[验证范围与限制](release-1.0.4.md)见项目首页。
...
收起执行过程时，摘要随最新工具动作更新：优先显示调用中的简短说明，否则显示工具动作与文件路径、命令或搜索词；执行中显示最新动作和状态，全部动作结束后恢复简写汇总。Job 等通用工具调用、普通上下文和 Todo／运行状态记录也收进抽屉；上下文压缩保持独立。展开仍可查看原记录、参数、结果与失败详情。
